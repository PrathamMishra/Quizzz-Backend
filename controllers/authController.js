...
exports.signup = catchAsync(async (req, res, next) => {
    ...
    const verficationURL = `${req.protocol}://${req.get(
        "host"
    ...
    try {
        ...
        return next(
            new AppError(
                "ther was an error sending the email. Try again later!",
                500
            )
        );
    }
...
exports.login = catchAsync(async (req, res, next) => {
    ...
    if (!user.verifed) {
        ...
        return next(
            new AppError("email is not verifed create you new account", 400)
        );
    }
